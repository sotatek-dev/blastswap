import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from '@blast/v2-sdk'
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const tokenPairs: [Currency | undefined, Currency | undefined][] = useMemo(
    () => [
      ...
      [wrapped?.equals(USDC) ? undefined : wrapped, chainId === ChainId.SEPOLIA ? USDC : undefined],
      [chainId ? WETH[chainId] : undefined, chainId === ChainId.SEPOLIA ? USDC : undefined]
    ],
